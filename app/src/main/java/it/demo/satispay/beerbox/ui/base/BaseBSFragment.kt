package it.demo.satispay.beerbox.ui.base
...
import it.demo.satispay.beerbox.utils.observe

abstract class BaseBSFragment<DB : ViewDataBinding, VM : BaseViewModel> : BottomSheetDialogFragment() {
